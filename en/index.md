...
[Intro](index.md) · [Install](install.md) · [Guide](guide.md) · [Voices & Models](voices.md) · [FAQ](faq.md) · [Privacy](privacy.md) · [Changelog](changelog.md) | **[简体中文](../zh/index.md)**
...
- 🔖 **Resume anywhere** — progress auto-saved every few seconds; synthesis picks up where it stopped, and playing a partially generated chapter auto-continues generation
- 💾 **Per-chapter memory** — position and bookmark saved per file; return to a chapter or restart the app and it picks up where you left off
